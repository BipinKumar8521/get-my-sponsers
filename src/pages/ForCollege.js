...
export default function ForCollege() {
  ...
  return (
    <div className="for-college">
      <Card className="college-card">
        <h1>Fill details of College</h1>
        <form action="">
          <Input
            id="collegeName"
            element="input"
            ...
            errorText="Please enter a valid college name."
            label="College Name"
          ...
          <Input
            ...
            type="text"
            validators={[VALIDATOR_REQUIRE()]}
            errorText="Please enter a valid fest name."
            label="Fest Name"
            onInput={InputHandler}
          />
          <Input
            ...
            label="Brief description about fest"
            onInput={InputHandler}
          />
          <Input
            id="festWebsite"
